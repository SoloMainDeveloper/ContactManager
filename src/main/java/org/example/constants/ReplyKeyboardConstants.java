...
public class ReplyKeyboardConstants {
    ...
    public static final List<String> MAIN_MENU = List.of(
        UserCommandConstants.CONTACTS, UserCommandConstants.GROUPS);

    /**
     * Кнопки меню контактов
     */
    public static final List<String> CONTACTS_MENU = List.of(
        UserCommandConstants.ADD, UserCommandConstants.GET_ALL,
        UserCommandConstants.FIND, UserCommandConstants.BACK);

    /**
     * Кнопки меню текущего контакта
     */
    public static final List<String> CURRENT_CONTACT_MENU = List.of(
        UserCommandConstants.INFO, UserCommandConstants.EDIT,
        UserCommandConstants.BLOCK, UserCommandConstants.DELETE,
        UserCommandConstants.BACK);

    /**
     * Кнопки меню добавления контакта
     */
    public static final List<String> ADD_CONTACT_MENU = List.of(
        UserCommandConstants.NUMBER, UserCommandConstants.AGE,
        UserCommandConstants.GENDER, UserCommandConstants.SAVE_CONTACT,
        UserCommandConstants.BACK);
    ...
    public static final List<String> FIND_CONTACT_MENU = List.of(
        UserCommandConstants.FIND_BY_NAME, UserCommandConstants.FIND_BY_NUMBER,
        UserCommandConstants.BACK);
    ...
    public static final List<String> EDIT_CONTACT_MENU = List.of(
        UserCommandConstants.NAME, UserCommandConstants.NUMBER,
        UserCommandConstants.AGE, UserCommandConstants.GENDER,
        UserCommandConstants.EDIT_CONTACT, UserCommandConstants.BACK);

    /**
     * Кнопки меню получения всех контактов
     */
    public static final List<String> GET_ALL_CONTACTS_MENU = List.of(
        UserCommandConstants.GET, UserCommandConstants.ADD_FILTER,
        UserCommandConstants.ADD_ORDER, UserCommandConstants.BACK);

    /**
     * Кнопки меню фильтрации
     */
    public static final List<String> ADD_FILTER_MENU = List.of(
        UserCommandConstants.FILTER_BY_GENDER, UserCommandConstants.FILTER_BY_AGE,
    ...
    public static final List<String> ADD_GROUP_MENU = List.of(
        UserCommandConstants.ADD_CONTACT_TO_GROUP,
        UserCommandConstants.SAVE_GROUP, UserCommandConstants.BACK);

    /**
     * Кнопки меню текущего группы
     */
    public static final List<String> CURRENT_GROUP_MENU = List.of(
        UserCommandConstants.GET_GROUP_CONTACTS, UserCommandConstants.EDIT,
        UserCommandConstants.DELETE, UserCommandConstants.BACK);

    /**
     * Кнопки меню редактирования группы
     */
    public static final List<String> EDIT_GROUP_MENU = List.of(
        UserCommandConstants.CHANGE_GROUP_NAME,
        UserCommandConstants.DELETE_CONTACT_FROM_GROUP,
        UserCommandConstants.ADD_CONTACT_TO_GROUP,
        UserCommandConstants.SAVE_GROUP, UserCommandConstants.BACK);
    ...
    public static final List<String> DATA_MENU = List.of(
        UserCommandConstants.IMPORT_CONTACTS, UserCommandConstants.EXPORT_CONTACTS,
        UserCommandConstants.BACK);
}
